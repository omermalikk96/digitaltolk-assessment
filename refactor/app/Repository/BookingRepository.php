...
class BookingRepository extends BaseRepository
{
     ...
     * @param Job $model
     */
    function __construct(Job $model, JobRepository $jobRepository, MailerInterface $mailer)
    {
    ...
    {
        return $this->jobRepository->storeJobEmail($data);
    }
     ...
     * @return array
     */
    public function jobToData($data)
    {
        $this->jobRepository->jobToData($data);
    }
    ...
    {
        $this->jobRepository->jobEnd($post_data);
    }
    ...
    public function sendNotificationTranslator($job, $data = [], $exclude_user_id)
    {
        ...
        foreach ($users as $oneUser) {
            if ($oneUser->user_type == '2' && $oneUser->status == '1' && $oneUser->id != $exclude_user_id) { // user is translator and he is not disabled
                ...
                $jobs = $this->jobRepository->getPotentialJobIdsWithUserId($oneUser->id); // get all potential jobs of this user
    ...
    public function sendSMSNotificationToTranslator($job)
    {
        ...
        foreach ($translators as $translator) {
            ...
            $status = SendSMSHelper::send(config('SMS_NUMBER'), $translator->mobile, $message);
